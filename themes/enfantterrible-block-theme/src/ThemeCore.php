...
class ThemeCore {
	...
	public function setup() {
		add_action( 'init', [ $this, 'init' ], apply_filters( 'enfantterrible_block_theme_init_priority', 8 ) );
		...
		do_action( 'enfantterrible_block_theme_loaded' );
	}
	...
	public function i18n() {
		load_theme_textdomain( 'enfantterrible-theme', ENFANTTERRIBLE_BLOCK_THEME_PATH . '/languages' );
	}
	...
	public function init() {
		do_action( 'enfantterrible_block_theme_before_init' );
		...
		ModuleInitialization::instance()->init_classes( ENFANTTERRIBLE_BLOCK_THEME_INC );
		do_action( 'enfantterrible_block_theme_init' );
	}
